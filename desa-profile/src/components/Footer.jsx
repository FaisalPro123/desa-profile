      ...
      <div className="footer-inner">
        <div className="footer-grid">
          ...
          <div className="footer-section">
            <h3>Menu</h3>
            <ul>
              {['Profil', 'Anggota', 'Statistik', 'Peta', 'Berita', 'UMKM', 'CCTV', 'Pengaduan'].map(l => (
                <li key={l}><button style={{background:'none',border:'none',color:'rgba(255,255,255,.7)',padding:0,cursor:'pointer',fontSize:'.9rem',textAlign:'left',font:'inherit'}}>{l}</button></li>
              ))}
            </ul>
          </div>
          <div className="footer-section">
